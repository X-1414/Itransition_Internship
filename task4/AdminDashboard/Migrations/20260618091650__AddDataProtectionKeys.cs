...
{
    /// <inheritdoc />
    public partial class _AddDataProtectionKeys : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(name: "DataProtectionKeys", columns: table=> new
            {
            ...
            constraints: table => {table.PrimaryKey("PK_DataProectionKeys", x=>x.Id);});
        }
